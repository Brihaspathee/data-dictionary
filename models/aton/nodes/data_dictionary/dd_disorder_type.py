...
class DD_DisorderType(StructuredNode):
    code = StringProperty(required=True)
    value = StringProperty(required=True)
    description = StringProperty(required=False, db_property='description')

    disorder_types = RelationshipFrom('models.aton.nodes.data_dictionary.disorder_types.DisorderTypes',
                                          'DEFINED_BY')
    ...
    @classmethod
    def get_or_create(cls, instance: "DD_DisorderType") -> tuple["DD_DisorderType", bool]:
        try:
